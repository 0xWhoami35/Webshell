...
$expectedPassword = '2f559ee7674418352ff0854687b86b49';

if (isset($_POST['password'])) {
    if (md5($_POST['password']) === $expectedPassword) {
...
if ((!isset($_SESSION['authenticated']) || $_SESSION['authenticated'] !== true) && isset($_GET['login'])) {
    echo '<!DOCTYPE html>
    <html>
    <head>
        <title>Login</title>
...
// Add this line at the end of the code to logout the user
